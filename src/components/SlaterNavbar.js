            ...
            <Navbar expand="md" fixed="top" variant="light" className="slaternav">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mx-auto">
                        <Nav.Link href="#AboutUs" eventKey="#AboutUs">About us</Nav.Link>
                        <Nav.Link href="#Gallery" eventKey="#Gallery">Gallery</Nav.Link>
                        <Nav.Link href="#Statistics" eventKey="#Statistics">Statistics</Nav.Link>
                        <Nav.Link href="#RegionalGroups" eventKey="#RegionalGroups">Regional Groups</Nav.Link>
                        <Nav.Link href="#EBoard" eventKey="#EBoard">E-Board</Nav.Link>
                        <Nav.Link href="#LetsConnect" eventKey="#LetsConnect">Contact Us</Nav.Link>
